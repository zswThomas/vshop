            ...
            <ul>
              <li class="food-item bottom-border-1px" v-for="(food, index) in good.foods" :key="index"
                ...
                <div class="content">
                  ...
                  <div class="extra">
                    <span class="count">月售{{food.sellCount}}份{{currentIndex}}{{index}}</span>
...
import CartControl from '../../../components/CartControl/CanControl'
